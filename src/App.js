...
class App extends Component {
  ...
  render() {
    const {time, isTimerRunning, category, imgUrl, score} = this.state
      ...
      <div className="bg-container">
        <nav className="nav-bar">
          ...
          <ul className="nav-ul-list">
            <li>
              <p className="about">
                Score: <span className="about">{score}</span>
              </p>
            </li>
            <li>
              <img
          ...
          {!isTimerRunning && (
            <div className="first-card">
              ...
              <ul className="labels-container">
                {tabsList.map(each => (
                  <li key={each.tabId} className="list-type">
                    <button
                      className="button-label"
                      type="button"
                      onClick={() => this.TabClicked(each.tabId)}
                    >
                      {each.displayText}
                    </button>
                  </li>
              ...
              <ul className="thumbnail-images-container">
                {thumbnailList.map(each => (
                  <li key={each.id} className="image-list-item">
                    <button
                      type="button"
                      className="image-button"
                      onClick={() => this.imagesClicked(each.thumbnailUrl)}
                    >
                      <img
            ...
            <div className="score-card-container">
              ...
              >
                <img
                  ...
                  alt="reset"
                />
                <p className="about">PLAY AGAIN</p>
              </button>
            </div>
          )}
        </div>
